  ...
  return (
    <section className="max-w-6xl mx-auto p-8">
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
        ...
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">DevOps / SRE / Software Engineer</h2>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="flex flex-wrap gap-4">
          <a
            ...
            className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors duration-300"
          >
          ...
          <a
            href="tel:724-875-2428"
            className="inline-flex items-center px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors duration-300"
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
