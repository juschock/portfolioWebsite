    ...
    <section className="site-shell section">
      <div className="contact-panel">
        ...
        <div className="contact-links">
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=joshua@racoben.com&su=Project%20inquiry"
            target="_blank"
            rel="noreferrer"
            aria-label="Email Joshua Uschock using Gmail"
          >
            <span className="contact-link-label"><strong>Email Joshua</strong><small>joshua@racoben.com · Opens Gmail</small></span>
